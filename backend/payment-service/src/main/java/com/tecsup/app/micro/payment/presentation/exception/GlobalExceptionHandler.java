package com.tecsup.app.micro.payment.presentation.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleDomainException(PaymentDomainException ex, HttpServletRequest request) {
